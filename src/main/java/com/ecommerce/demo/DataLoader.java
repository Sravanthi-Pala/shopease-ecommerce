...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Long count = (Long) entityManager.createNativeQuery("SELECT COUNT(*) FROM products").getSingleResult();
        ...
        if (count == 0) {
            ...
            entityManager.createNativeQuery("INSERT INTO products (name, price, original_price, discount, category, brand, stock, rating, rating_count, description, image_url) VALUES " +
                ...
                "('Parker Pen Set', 299, 699, '57% off', 'Stationery', 'Parker', 500, 4.7, 3456, 'Premium pen set', '/images/paker.jpg')," +
                ...
                "('Maybelline Foundation', 449, 584, '23% off', 'Beauty', 'Maybelline', 150, 4.2, 311, 'Liquid foundation', '/images/maybeline.jpg')," +
                "('Nyx Eyeshadow Palette', 899, 1999, '55% off', 'Beauty', 'Nyx', 300, 4.7, 3456, '12-color palette', '/images/nyx-professional.jpg')," +
                ...
                "('Restorative Hair Mask', 249, 599, '58% off', 'Beauty', 'Biotique', 600, 4.5, 2345, 'Hair mask', 'https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?w=300')").executeUpdate();
            
            System.out.println("✅ 41 products loaded permanently!");
        } else {
